...
const OG_DEFAULT = "https://fichedepute.fr/og.png";
const SUB = "Participation, votes et absences de votre député à l'Assemblée nationale — en clair et 100 % sourcé.";
...
function metaFor(pathname) {
  ...
  if (fiche) {
    ...
    if (d) {
      ...
      return {
        title: `${name} (${d.groupe}) — FicheDéputé.fr`,
        desc: `${name}, député·e ${circo}. ${d.presence}% de participation aux scrutins publics, votes, loyauté au groupe et activité législative — 100 % sourcé (Assemblée nationale).`,
  ...
  const pages = {
    "/deputes": ["Tous les députés — FicheDéputé.fr", "Cherchez et comparez les 577 députés de la 17ᵉ législature : participation, votes, groupe et circonscription."],
    ...
    "/groupes": ["Les groupes politiques — FicheDéputé.fr", "Participation moyenne et effectifs de chaque groupe politique de l'Assemblée nationale."],
  ...
  return { title: "FicheDéputé.fr — La fiche vivante de votre député·e", desc: SUB, canonical: `${BASE}/`, og: OG_DEFAULT };
}
